...
public class CourseAttendanceAdapter extends RecyclerView.Adapter<CourseAttendanceAdapter.MyViewHolder> {

    private Context mContext;
    private List<Subject> mData;


    public CourseAttendanceAdapter(Context mContext, List<Subject> mData) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(mContext, StudentListAttendanceActivity.class);
